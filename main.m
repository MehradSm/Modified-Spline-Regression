...
srr_hist_rc = [(yhi_hist_rc(1) + ylo_hist_rc(1))/avg_midl_rc  (yhi_hist_rc(end) + ylo_hist_rc(end))/avg_midl_rc];
srr_hist_c = [(yhi_hist_c(1) + ylo_hist_c(1))/avg_midl_c  (yhi_hist_c(end) + ylo_hist_c(end))/avg_midl_c];
srr_hist_mc =  [(yhi_hist_mc(1) + ylo_hist_mc(1))/avg_midl_mc  (yhi_hist_mc(end) + ylo_hist_mc(end))/avg_midl_mc];
